...
import JoinQueue from "@/components/events/join-queue";
import Spinner from "@/components/events/spinner";
              ...
              <div className="space-y-8">
                ...
                <div className="bg-blue-50 border border-blue-100 rounded-lg p-6">
                  ...
                  <ul className="space-y-2 text-blue-700">
                    <li>• Please arrive at least 30 minutues before the event starts</li>
